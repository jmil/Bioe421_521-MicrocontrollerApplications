...
\date{\textbf{Fall 2017\\Lectures are on Tuesdays, 2:00--3:30 pm BRC 286\\Labs are on Thursdays, 1:30--6:00 pm OEDK Computer Lab, Room 112}}                                           % Activate to display a given date or no date
\author{Instructor: Jordan Miller, Office: BRC 415, Contact: \href{mailto:jmil@rice.edu}{jmil@rice.edu}} %\\ TA: TBD, Contact: \href{mailto:TBD@}{TBD@}}
\def\projectOutlineDue{October 19th} % Set this to the second-to-last Thursday in October
\def\termPaperDue{November 27th} % Set this to the Monday of the last week of class lectures
